...
(function($){
    ...
    function mainMap() {
      ...
      var locations = [
        ...
        [ locationData('listings-single-page.html','images/listing-item-01.jpg',"ไทจินดา เรสซิเด้น",'ถ.มิตรภาพ ศิลา เมืองขอนแก่น ขอนแก่น', '4.5', '12'), 16.4765128,102.8223782, 8, '<i class="im im-icon-Chef-Hat"></i>'],
